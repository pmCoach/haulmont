...
public class CreditOfferEditUI extends VerticalLayout {
    ...
    public CreditOfferEditUI(CreditOffer creditOffer, CreditOfferView creditOfferView) throws SQLException, IOException {
        setVisible(false);
        if (creditOffer == null) {
    ...
    private void updateSelects() throws SQLException, IOException {
    ...
    private void addCreditOffer() throws SQLException, IOException {
        creditOffer = getCreditOffer();
        creditOfferService.addCreditOffer(creditOffer);
    }

    private void updateCreditOffer() throws SQLException, IOException {
